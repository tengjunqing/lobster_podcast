...
# 然后关联本地仓库：
cd ~/lobster_podcast
git remote add origin git@github.com:你的用户名/lobster_podcast.git
git branch -M main
...
### 4. iPhone 订阅
1. 复制 RSS 地址：`https://你的用户名.github.io/lobster_podcast/feed.xml`
...
```
示例：`20260603_Morning_TechReview.mp3`
